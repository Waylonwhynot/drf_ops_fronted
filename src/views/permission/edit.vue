<template>
  <el-dialog :close-on-click-modal="false" :visible.sync="visible" :title="curId ? '编辑权限' : '新增权限'" width="700px" :before-close="close">
...
<script>
import { getPermission, updatePermission, createPermission, getPermissionMethods } from '@/api/permissions'
